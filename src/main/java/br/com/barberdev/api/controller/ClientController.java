...
import br.com.barberdev.api.mapper.IClientMapper;
...
public class ClientController {
    ...
    UpdateClientResponse update(
        ...
        final var entity = mapper.toEntity(id, request);
    ...
    ClientDetailResponse findById(@PathVariable final long id) {
        final var entity = queryService.findById(id);
        return mapper.toDetailResponse(entity);
    }

    @GetMapping
    List<ListClientResponse> list() {
        final var entities = queryService.list();
